    ...
    >
      ...
      <div className="grid flex-1 grid-cols-[0.95fr_1.05fr] gap-14">
        ...
        <div className="flex flex-col justify-center gap-6">
          <p className="reveal text-[22px] leading-relaxed text-ink/85">
          ...
          <div className="reveal">
            <p className="text-[22px] leading-relaxed text-ink/85">
              Les infirmiers sont{" "}
            ...
            <div className="mt-4 flex flex-wrap gap-2.5">
              {PILIERS.map((p) => (
                <span
                  key={p}
                  className="rounded-full border border-clinic/30 bg-clinic-soft/40 px-4 py-1.5 text-[19px] font-medium text-clinic-deep"
                >
                  {p}
                </span>
              ))}
      ...
      <div className="reveal relative rounded-2xl border border-hair/60 border-l-[5px] border-l-coral bg-white/55 px-10 py-6 backdrop-blur-sm">
        ...
        <div className="relative mt-4 min-h-[6.5rem]">
          <p key={questionIndex} className="problem-question font-display text-[1.6rem] italic leading-snug text-clinic-deep">
  ...
  return (
    <div className="reveal relative flex items-center gap-5 overflow-hidden rounded-2xl border border-hair/60 bg-white/55 px-7 py-5 backdrop-blur-sm">
      ...
      <div className="relative">
        ...
        <p className="mt-1.5 max-w-[24ch] text-[19px] leading-snug text-muted">
          {caption}
        </p>
      </div>
    </div>
