...
const CARDS: Card[] = [
  {
    ...
    copy: "Une majorité relie l'infection à HPV au risque de cancer du col de l'utérus, repère clé du discours de prévention.",
  ...
  },
  {
    ...
    copy: "Le dépistage systématique est considéré indispensable pour les adolescents et les personnes à risque.",
