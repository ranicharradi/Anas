      ...
      <section className="cb-panel flex h-[610px] flex-col overflow-hidden rounded-lg border border-hair/60 bg-white/55 shadow-[0_28px_90px_rgba(27,29,36,0.12)] backdrop-blur-sm">
          ...
          {messages.map((message, index) => (
            ...
            >
              <div
                className={
                  message.role === "user"
                    ? "max-w-[80%] rounded-2xl rounded-br-sm bg-clinic px-4 py-3 text-[15px] leading-relaxed text-paper"
                    : "max-w-[85%] rounded-2xl rounded-bl-sm border border-hair/50 bg-white/80 px-4 py-3 text-[15px] leading-relaxed text-ink"
                }
              >
                {message.content ||
        ...
        >
          <input
            ...
            className="flex-1 rounded-full border border-hair/60 bg-white/80 px-5 py-3 text-[15px] text-ink outline-none placeholder:text-muted focus:border-clinic"
          />
          <button
            type="submit"
