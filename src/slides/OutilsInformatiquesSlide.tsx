  ...
  return (
    <div ref={root} className="grid h-full grid-cols-[0.82fr_1.18fr] items-center gap-12 px-20 py-12">
      <section>
        ...
        <p className="tools-sub mt-5 max-w-lg text-[22px] leading-relaxed text-muted">
          ...
          {TOOLS.map((tool) => (
            ...
            >
              ...
              <div className="mt-5">
                ...
                <p className="mt-1 text-[19px] font-semibold" style={{ color: tool.color }}>
                  {tool.role}
                </p>
                <p className="mt-3 text-[19px] leading-relaxed text-muted">{tool.detail}</p>
              </div>
            </article>
          ))}
        </div>
